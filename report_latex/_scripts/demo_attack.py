"""
Demo nhanh tren dong lenh: lay "dau van tay" 4 phim cua mot nguoi dung that
(them nhieu nhe) roi chay thuat toan Scoreboard-RH de giai an danh.
"""
from attack_engine import AttackEngine
import pandas as pd

VICTIM = 200  # mot nguoi dung co that trong MovieLens 100k
